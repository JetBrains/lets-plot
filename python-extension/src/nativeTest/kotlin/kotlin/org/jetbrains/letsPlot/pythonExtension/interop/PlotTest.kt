...
// TODO: Uncomment this after implementing LaTeX fractions on canvas
/*
    @Test
    fun `latex fractions`() {
        val spec = """
              ...
              "layers": [
                {
                  ...
                  "mapping": {
                    ...
                    "label": [
                      ...
                      "\\( a^{b_{\\frac{c}{d}}} \\)",
                      "a+\\( \\frac{b}{c} \\)",
                      "\\( \\frac{a}{b}\\)XY\\(\\frac{c}{d} \\)",
                      "\\( \\frac{a}{b} \\)+c",
                      "\\(\\frac{a}{b}\\)\n\\(c_i\\)",
                      "<a href=\"https://example.com\">link</a>\\(\\frac{a}{b}\\)"
                    ]
                  },
                  "data_meta": {},
                  "family": "Noto Sans",
        ...
        assertPlot("plot_latex_fractions_test.png", plotSpec)
    }

    @Test
    fun `latex fraction with horizontal anchor`() {
        val spec = """
            {
              "theme": { "name": "classic", "line": "blank", "axis": "blank" },
              "mapping": {},
        ...
        assertPlot("plot_latex_fraction_horizontal_anchor_test.png", plotSpec)
    }

    @Test
    fun `latex complex formulas`() {
        val spec = """
            {
              "theme": { "name": "classic", "line": "blank", "axis": "blank" },
              "mapping": {},
              ...
              "layers": [
                {
                  ...
                  "mapping": {
                    ...
                    "label": [
                      ...
                      "\\( a^\\frac{c+d}{e}+b_{\\frac{f}{g+h}} \\)",
                      "\\( a1^{b1^{\\frac{c1}{c2}+c3}+b2}+a2 \\)"
                    ]
                  },
                  "data_meta": {},
                  "x": 0.0,
        ...
        assertPlot("plot_latex_complex_formulas_test.png", plotSpec)
    }
*/
