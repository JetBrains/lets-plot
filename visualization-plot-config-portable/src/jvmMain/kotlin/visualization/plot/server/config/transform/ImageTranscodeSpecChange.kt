...
import jetbrains.datalore.visualization.plot.config.Option.Geom.Image.HREF
import jetbrains.datalore.visualization.plot.config.Option.Geom.Image.SPEC
import jetbrains.datalore.visualization.plot.config.Option.Geom.Image.Spec.BYTES
import jetbrains.datalore.visualization.plot.config.Option.Geom.Image.Spec.HEIGHT
import jetbrains.datalore.visualization.plot.config.Option.Geom.Image.Spec.TYPE
import jetbrains.datalore.visualization.plot.config.Option.Geom.Image.Spec.WIDTH
