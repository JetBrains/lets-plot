...
import jetbrains.datalore.visualization.plot.config.Option.Guide.COLOR_BAR
import jetbrains.datalore.visualization.plot.config.Option.Guide.COLOR_BAR_GB
import jetbrains.datalore.visualization.plot.config.Option.Guide.ColorBar.BIN_COUNT
import jetbrains.datalore.visualization.plot.config.Option.Guide.ColorBar.HEIGHT
import jetbrains.datalore.visualization.plot.config.Option.Guide.ColorBar.WIDTH
import jetbrains.datalore.visualization.plot.config.Option.Guide.Legend.BY_ROW
import jetbrains.datalore.visualization.plot.config.Option.Guide.Legend.COL_COUNT
import jetbrains.datalore.visualization.plot.config.Option.Guide.Legend.ROW_COUNT
import jetbrains.datalore.visualization.plot.config.Option.Guide.NONE
import jetbrains.datalore.visualization.plot.config.Option.Guide.REVERSE
