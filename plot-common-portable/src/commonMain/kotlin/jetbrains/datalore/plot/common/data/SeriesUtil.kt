...
object SeriesUtil {
     ...
     */
    fun ensureApplicableRange(range: ClosedRange<Double>?, preferrableNullRange: ClosedRange<Double>? = null): ClosedRange<Double> {
        if (range == null) {
            return preferrableNullRange ?: ClosedRange(-0.5, 0.5)
        }
        if (isSubTiny(range)) {
