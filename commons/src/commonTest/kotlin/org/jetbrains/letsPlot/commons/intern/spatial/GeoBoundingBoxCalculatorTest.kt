...
import org.jetbrains.letsPlot.commons.intern.spatial.GeoBoundingBoxCalculator.Companion.calculateLoopLimitRange
import org.jetbrains.letsPlot.commons.intern.spatial.GeoRectangleTestHelper.point
...
class GeoBoundingBoxCalculatorTest {
    ...
    fun calculateLoopLimitRangeForSingleRange() {
        ...
        val segments = sequenceOf(
            org.jetbrains.letsPlot.commons.intern.spatial.Segment(
                range.lowerEnd,
                range.upperEnd
            )
        )
