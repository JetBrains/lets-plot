...
##### 5. Build python wheels with Python 3.8, 3.9 and 3.10:

 - edit `bin` and `include` paths in the `Python settings` section: set paths to Python 3.8
 - run `./gradlew python-package-build:build`
 
Reproduce this steps for Python 3.9 and 3.10

_Then you'll get python wheel files built with Python 3.7, 3.8, 3.9 and 3.10._
