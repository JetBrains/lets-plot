...
open class AllColorScales : DemoBase() {
    ...
    companion object {
        ...
        private fun listOfInts(fromValue: Int, toValue: Int): List<Int> {
            val increment = Math.round(Math.signum((toValue - fromValue).toFloat()))
...
*/
        ...
        private fun specWithContinuousColors(fromX: Int, toX: Int, scale_mapper_kind: String, scaleParams: Map<String, *> = emptyMap<String, Any>()): String {
            val paramsCopy = HashMap<String, Any>(scaleParams)
