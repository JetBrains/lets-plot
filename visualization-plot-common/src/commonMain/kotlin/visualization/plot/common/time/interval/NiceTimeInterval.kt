...
object NiceTimeInterval {
    ...
    private val AUTO_INTERVALS = arrayOf(TimeInterval.seconds(1), TimeInterval.seconds(5), TimeInterval.seconds(15), TimeInterval.seconds(30),

            TimeInterval.minutes(1), TimeInterval.minutes(5), TimeInterval.minutes(15), TimeInterval.minutes(30),

            TimeInterval.hours(1), TimeInterval.hours(3), TimeInterval.hours(6), TimeInterval.hours(12),

            TimeInterval.days(1), TimeInterval.days(2),

            TimeInterval.weeks(1),

            TimeInterval.months(1), TimeInterval.months(3),
