...
class DateTimeFormatUtilTest {
    ...
    fun month() {
        ...
        val m = DateTimeFormatUtil.formatDateUTC(baseInstant, "M")
        assertEquals("8", m)
        val mm = DateTimeFormatUtil.formatDateUTC(baseInstant, "MM")
        assertEquals("08", mm)
        val mmm = DateTimeFormatUtil.formatDateUTC(baseInstant, "MMM")
        assertEquals("Aug", mmm)
        val mmmm = DateTimeFormatUtil.formatDateUTC(baseInstant, "MMMM")
        assertEquals("August", mmmm)
        val mmmmm = DateTimeFormatUtil.formatDateUTC(baseInstant, "MMMMM")
        assertEquals("August", mmmmm)   // ?
        val mmmmmm = DateTimeFormatUtil.formatDateUTC(baseInstant, "MMMMMM")
