package org.jetbraibs.letsPlot.imagick.canvas
...
class CanvasTextTest {
    ...
    fun assertCanvas(expectedFileName: String, canvas: MagickCanvas, imageComparer: ImageComparer = CanvasTextTest.imageComparer) {
    ...
    fun createCanvas(width: Number = 100, height: Number = 100, pixelDensity: Double = 1.0, fontManager: MagickFontManager = embeddedFontsManager): Pair<MagickCanvas, Context2d> {
        val canvas = MagickCanvas.Companion.create(width = width, height = height, pixelDensity = pixelDensity, fontManager = fontManager)
    ...
    companion object {
        ...
        val monoRegularFontManager by lazy {
            MagickFontManager.Companion.configured(
                "mono" to MagickFontManager.FontSet(
                    embedded = true,
                    "NotoMono",
        ...
        private val serifRegularOnlyFontManager by lazy {
            MagickFontManager.Companion.configured(
                "serif" to MagickFontManager.FontSet(
                    embedded = true,
                    "NotoSerif",
