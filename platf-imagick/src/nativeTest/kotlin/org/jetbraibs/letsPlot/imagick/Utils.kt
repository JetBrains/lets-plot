package org.jetbraibs.letsPlot.imagick
...
fun createImageComparer(fontManager: MagickFontManager): ImageComparer {
    ...
    val bitmapIO = NativeBitmapIO(
        expectedImagesDir = "/src/nativeTest/resources/expected-images",
        outputDir = "/build/reports/actual-images"
    )

    return ImageComparer(canvasPeer, bitmapIO, silent = true)
}
