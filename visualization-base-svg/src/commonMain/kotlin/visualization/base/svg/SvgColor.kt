...
object SvgColors {
    ...
    private fun createSvgColorList(): Map<String, SvgColorKeyword> {
        val colorList = HashMap<String, SvgColorKeyword>()
        SvgColorKeyword.values().forEach { colorList[it.toString().toLowerCase()] = it }
        return colorList
    }
    ...
    enum class SvgColorKeyword(private val literal: String) : SvgColor {
