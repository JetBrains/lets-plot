...
class SvgEllipseElement() : SvgGraphicsElement(), SvgTransformable, SvgShape {
    ...
    companion object {
        private val CX = SvgAttributeSpec.createSpec("cx")
        private val CY = SvgAttributeSpec.createSpec("cy")
        private val RX = SvgAttributeSpec.createSpec("rx")
        private val RY = SvgAttributeSpec.createSpec("ry")
    }
}