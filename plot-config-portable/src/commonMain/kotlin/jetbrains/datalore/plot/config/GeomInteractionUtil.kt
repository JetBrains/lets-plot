...
object GeomInteractionUtil {
    ...
    internal fun createGeomInteractionBuilder(
        ...
        val builder = createGeomInteractionBuilder(
            ...
            multilayer,
            isTooltipForAesEnabled(layerConfig, scaleMap, Aes.X),
            isCrosshairEnabled
        )
    ...
    private fun createTooltipAesList(
        ...
        aesListForTooltip.retainAll { aes -> isTooltipForAesEnabled(layerConfig, scaleMap, aes) }
    ...
    private const val MIN_FACTORS_TO_SHOW_TOOLTIPS = 4
    private fun isTooltipForAesEnabled(layerConfig: LayerConfig, scaleMap: TypedScaleMap, aes: Aes<*>): Boolean {
        ...
        return if (variable != null) {
            val factors = layerConfig.combinedData.distinctValues(variable)
            factors.size > MIN_FACTORS_TO_SHOW_TOOLTIPS
        } else {
            true
        }
    }
