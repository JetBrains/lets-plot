...
import org.jetbrains.letsPlot.livemap.mapengine.viewport.convertCellKeyToQuadKeys
...
internal class TileDataFetcherImpl(private val myMapProjection: MapProjection, private val myTileService: TileService) :
    ...
    override fun fetch(cellKey: CellKey): Async<List<TileLayer>> {
        ...
        println("Fetching tile data for CellKey: ${cellKey.key}, Zoom: $zoom, BBox: $bbox, QuadKeys: ${quadKeys.map { it.key }}")
