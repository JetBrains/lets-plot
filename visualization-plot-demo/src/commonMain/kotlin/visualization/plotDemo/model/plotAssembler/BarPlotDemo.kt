...
import jetbrains.datalore.visualization.plot.gog.plot.scale.DefaultMapperProviderUtil
...
//                .groupingVar(null)
    ...
    companion object {
        ...
        private fun colorScale(name: String, domain: List<*>, colors: List<Color>): Scale2<Color> {
