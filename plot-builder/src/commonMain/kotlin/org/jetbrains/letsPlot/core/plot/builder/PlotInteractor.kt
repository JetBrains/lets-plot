...
import org.jetbrains.letsPlot.core.plot.base.tooltip.TooltipInteractor
...
internal class PlotInteractor(
    ...
    private val tooltipInteractor: TooltipInteractor
    ...
    init {
        ...
        reg.add(Registration.from(tooltipInteractor))
    }
