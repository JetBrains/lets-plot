...
object FigureModelOptions {
    ...
    const val CURRENT_SCALE_RANGE = "current_scale_range" // array of two nullable numbers
    const val INITIAL_SCALE_RANGE = "initial_scale_range" // array of two nullable numbers
    const val SCALE_RATIO = "scale_ratio" // array of two nullable numbers
}