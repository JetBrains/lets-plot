...
abstract class AxisLabelsLayout protected constructor(val orientation: jetbrains.datalore.plot.builder.guide.Orientation, val axisDomain: ClosedRange<Double>, val labelSpec: PlotLabelSpec, val theme: AxisTheme) {
    ...
    companion object {
        ...
        fun horizontalFlexBreaks(orientation: jetbrains.datalore.plot.builder.guide.Orientation,
        ...
        fun horizontalFixedBreaks(orientation: jetbrains.datalore.plot.builder.guide.Orientation,
        ...
        fun verticalFlexBreaks(orientation: jetbrains.datalore.plot.builder.guide.Orientation,
                               axisDomain: ClosedRange<Double>, breaksProvider: AxisBreaksProvider, theme: AxisTheme): AxisLabelsLayout {
        ...
        fun verticalFixedBreaks(orientation: jetbrains.datalore.plot.builder.guide.Orientation, axisDomain: ClosedRange<Double>, breaks: GuideBreaks, theme: AxisTheme): AxisLabelsLayout {
            checkArgument(!orientation.isHorizontal, orientation.toString())
