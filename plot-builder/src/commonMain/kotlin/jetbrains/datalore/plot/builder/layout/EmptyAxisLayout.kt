...
class EmptyAxisLayout private constructor(xDomain: ClosedRange<Double>, yDomain: ClosedRange<Double>, private val myOrientation: jetbrains.datalore.plot.builder.guide.Orientation) : AxisLayout {
    ...
    companion object {
        fun bottom(xDomain: ClosedRange<Double>, yDomain: ClosedRange<Double>): AxisLayout {
            return EmptyAxisLayout(xDomain, yDomain, jetbrains.datalore.plot.builder.guide.Orientation.BOTTOM)
        }

        fun left(xDomain: ClosedRange<Double>, yDomain: ClosedRange<Double>): AxisLayout {
            return EmptyAxisLayout(xDomain, yDomain, jetbrains.datalore.plot.builder.guide.Orientation.LEFT)
        }
    }
}
