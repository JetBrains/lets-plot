...
import org.jetbrains.letsPlot.core.plot.builder.tooltip.TestUtil.first
import org.jetbrains.letsPlot.core.plot.builder.tooltip.TestUtil.last
import org.jetbrains.letsPlot.core.plot.builder.tooltip.TestUtil.multipolygon
...
class PolygonEdgeCasesTest {
    ...
    fun pathDataConstructor_ShouldNotReduceRingControlPoints() {
        ...
        val pathData = GeomUtil.createPathGroups(aes.dataPoints(), GeomUtil.TO_LOCATION_X_Y, sorted = true).values.toList()
