 ...
 */
internal class BinStat(binCount: Int, binWidth: Double?, private val myXPosKind: XPosKind, private val myXPos: Double) : BaseStat(DEF_MAPPING) {
    private val myBinOptions: StatUtil.BinOptions = StatUtil.BinOptions(binCount, binWidth)
    ...
    private fun computeStatSeries(data: DataFrame, rangeX: ClosedRange<Double>, valuesX: List<Double?>): StatUtil.BinsData {
        ...
        var b: StatUtil.CountAndWidth = StatUtil.binCountAndWidth(spanX, myBinOptions)
        ...
        val binsData = StatUtil.computeBins(valuesX, startX, binCount, binWidth, StatUtil.weightAtIndex(data), densityNormalizingFactor)
