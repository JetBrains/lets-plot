...
internal class RectTargetProjection private constructor(val data: DoubleRectangle) : TargetProjection() {

    fun x(): DoubleRange {
        return DoubleRange.withStartAndEnd(data.left, data.right)
    }
