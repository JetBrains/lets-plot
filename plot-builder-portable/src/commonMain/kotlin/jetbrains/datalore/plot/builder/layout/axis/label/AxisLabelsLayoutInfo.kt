...
class AxisLabelsLayoutInfo private constructor(b: Builder) {
    ...
    class Builder {
        ...
        internal var myLabelHorizontalAnchor: TextAnchor.HorizontalAnchor? = null
        internal var myLabelVerticalAnchor: TextAnchor.VerticalAnchor? = null
        ...
        fun labelHorizontalAnchor(anchor: TextAnchor.HorizontalAnchor): Builder {
            myLabelHorizontalAnchor = anchor
            return this
        }

        fun labelVerticalAnchor(anchor: TextAnchor.VerticalAnchor): Builder {
