...
package jetbrains.datalore.plot.builder.tooltip.data

import jetbrains.datalore.plot.builder.tooltip.TooltipFormatting
...
class ConstantField(
    ...
    private fun initFormattedValue(ctx: PlotContext): String {
        formattedValue = format?.let {
            ...
            val tooltipAes = when {
                org.jetbrains.letsPlot.core.plot.base.Aes.isPositionalXY(aes) -> org.jetbrains.letsPlot.core.plot.base.Aes.toAxisAes(aes, isYOrientation!!)
                else -> aes
            }
