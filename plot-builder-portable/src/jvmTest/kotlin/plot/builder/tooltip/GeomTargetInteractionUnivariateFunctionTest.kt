...
class GeomTargetInteractionUnivariateFunctionTest {
    ...
    private fun createUnivariateFunctionBuilder(displayableAes: org.jetbrains.letsPlot.core.plot.base.Aes<*>?): jetbrains.datalore.plot.builder.tooltip.TestingTooltipSpecsBuilder {
        return jetbrains.datalore.plot.builder.tooltip.TestingTooltipSpecsBuilder.Companion.univariateFunctionBuilder(
