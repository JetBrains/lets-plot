...
//    var exception = ExpectedException.none()
    ...
    fun step_ultraSmall() {
        ...
        assertEquals("50.1000000000",
            format(50.1, domainAndStep)
        )
        assertEquals("50.1000000005",
            format(50.1 + 5e-10, domainAndStep)
        )
        assertEquals("49.9999999999",
            format(50 - 1e-10, domainAndStep)
        )
        assertEquals("50.0000000000",
    ...
    fun both_ultraSmall() {
        ...
        assertEquals("5.000e-4",
            format(.0005, domainAndStep)
        )
        assertEquals("5.050e-4",
            format(.0005 + 5e-6, domainAndStep)
        )
        assertEquals("1.505e-3",
    ...
    fun domain_ultraLarge() {
        ...
        assertEquals("50,000,000",
            format(5e7, domainAndStep)
        )
        assertEquals("50,000,005",
    ...
    fun both_ultraLarge_scientific() {
        ...
        assertEquals("5.50e+7",
            formatScientific(
                5e7 + 5e6,
                domainAndStep
            )
        )
        assertEquals("1.05e+8",
            formatScientific(
                1e8 + 5e6,
                domainAndStep
            )
