...
import org.jetbrains.letsPlot.core.spec.Option.Scale.DISCRETE_DOMAIN
...
class ScaleConfigLabelsTest {
    ...
    fun `default scale`() {
        ...
        assertEquals(listOf("-0.4", "-0.2", "0", "0.2", "0.4"), xLabels)
        assertEquals(listOf("-0.4", "-0.2", "0", "0.2", "0.4"), yLabels)
    }
