...
class GeometryDataFrameBuilderTest {
    ...
    private class ExpectedDataBuilder {
        ...
        internal fun buildPoints(): Map<String, Any> {
            return mapOf(
                MAP_JOIN_KEY_COLUMN to myIdList,
                POINT_X to myXList,
                POINT_Y to myYList
            )
        }
    ...
    companion object {
        ...
        private fun createBoundaryCombiner(): GeometryDataFrameBuilder {
            return GeometryDataFrameBuilder(BOUNDARY)
        }

        private fun createCentroidCombiner(): GeometryDataFrameBuilder {
            return GeometryDataFrameBuilder(CENTROID)
        }

        private fun createLimitCombiner(): GeometryDataFrameBuilder {
            return GeometryDataFrameBuilder(LIMIT)
        }
    }
}