...
internal class GeoPositionsDataCombiner(private val myGeoDataKind: GeoDataKind) {
    ...
    val data: Map<String, Any>
        get() {
            val data = geometry
            data[MAP_COLUMN_JOIN_KEY] = myIds
            return data
        }
    ...
    val geometry: MutableMap<String, Any>
        get() {
            ...
            if (myGeoDataKind === GeoDataKind.LIMIT) {
                data[RECT_XMIN] = myLonMin
                data[RECT_XMAX] = myLonMax
                data[RECT_YMIN] = myLatMin
                data[RECT_YMAX] = myLatMax
            } else {
                data[POINT_X] = myLons
                data[POINT_Y] = myLats
            }
