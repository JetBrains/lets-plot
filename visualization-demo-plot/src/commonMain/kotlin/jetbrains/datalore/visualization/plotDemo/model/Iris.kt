...
object Iris {
    ...
    val df get() = run {
        mapOf(
            ...
            sepalWidth.name to sepalWidth.data,
            petalLength.name to petalLength.data,
            petalWidth.name to petalWidth.data,
            target.name to target.data
        )
    }
