...
//        return !p.frame().equals(AesInitValue.get(Aes.FRAME))
//    }
//
...
//            dataPointToMapObject(p, mapObjects::add)
//        }
//        return mapObjects
//    }
//
...
//        for (multiDataPoint in multiDataPoints) {
//            multiDataPointToMapObject(multiDataPoint, mapObjects::add)
//        }
//        return mapObjects
//    }
//
...
//        var lonlat: DoubleVector? = null
//        if (myLonLatInsideMapIdSpecified) {
//            lonlat = LonLatParser.parse(String.valueOf(p.mapId()))
//        }
//
//        if (lonlat != null) {
