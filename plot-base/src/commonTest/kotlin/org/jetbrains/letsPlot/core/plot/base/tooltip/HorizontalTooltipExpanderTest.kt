...
import org.jetbrains.letsPlot.core.plot.base.tooltip.layout.HorizontalTooltipExpander
...
class HorizontalTooltipExpanderTest {
    ...
    fun noOverlapping() {
        val expander =
            HorizontalTooltipExpander(MARGIN_BETWEEN_TOOLTIPS, DoubleSpan(0.0, 561.0))

        val fixed = expander.fixOverlapping(
            listOf(
                newTooltip(
                    text = "a",
    ...
    private fun newTooltip(
        ...
        return LayoutManager.PositionedTooltip(
            LayoutManager.MeasuredTooltip(spec, size, strokeWidth = 0.0),
            position,
            pointer
        )
    }
