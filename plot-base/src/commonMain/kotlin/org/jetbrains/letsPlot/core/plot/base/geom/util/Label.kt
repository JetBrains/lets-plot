...
interface Label {
    var paddingFactor: Double   // Amount of padding around label
    var radiusFactor: Double    // Radius of rounded corners
    var borderWidth: Double     // Size of a label border
    var alphaStroke: Boolean    // Apply alpha to text and border
    ...
    fun buildLabelComponent(
        ...
        val rectangle = labelRectangle(location, textSize, fontSize, hAnchor, vAnchor)
