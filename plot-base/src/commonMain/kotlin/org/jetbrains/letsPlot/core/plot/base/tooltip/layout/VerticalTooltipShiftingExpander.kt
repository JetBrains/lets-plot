...
import org.jetbrains.letsPlot.core.plot.base.tooltip.MathUtil.bottomEdgeOf
import org.jetbrains.letsPlot.core.plot.base.tooltip.MathUtil.leftEdgeOf
import org.jetbrains.letsPlot.core.plot.base.tooltip.MathUtil.rightEdgeOf
import org.jetbrains.letsPlot.core.plot.base.tooltip.MathUtil.topEdgeOf
...
internal class VerticalTooltipShiftingExpander(
    ...
    private fun checkSideOverlapping(
        tooltipSide: DoubleSegment,
        restrictedPart: DoubleSegment,
        intersection: DoubleRectangle,
        side: Side,
        overlappings: MutableMap<Side, Double>
    ) {
