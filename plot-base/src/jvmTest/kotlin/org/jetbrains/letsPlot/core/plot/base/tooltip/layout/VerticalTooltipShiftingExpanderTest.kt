...
import org.jetbrains.letsPlot.core.plot.base.tooltip.TestUtil.coord
import org.jetbrains.letsPlot.core.plot.base.tooltip.TestUtil.rect
...
import org.jetbrains.letsPlot.core.plot.base.tooltip.layout.VerticalTooltipShiftingExpanderTest.Intersection.Companion.center
import org.jetbrains.letsPlot.core.plot.base.tooltip.layout.VerticalTooltipShiftingExpanderTest.Intersection.OffsetDirection
import org.jetbrains.letsPlot.core.plot.base.tooltip.layout.VerticalTooltipShiftingExpanderTest.Intersection.Position.CENTER_SIDE
import org.jetbrains.letsPlot.core.plot.base.tooltip.layout.VerticalTooltipShiftingExpanderTest.Intersection.Position.OFFSET
import org.jetbrains.letsPlot.core.plot.base.tooltip.layout.VerticalTooltipShiftingExpanderTest.Intersection.Side
...
class VerticalTooltipShiftingExpanderTest {
    ...
    private fun positionedTooltip(tooltipRect: DoubleRectangle): PositionedTooltip {
        return positionedTooltip()
            ...
            .measuredTooltip(
                myTooltipsFactory.vertical(IGNORED_KEY, coord(0.0, 0.0)).size(tooltipRect.dimension).buildTooltip()
            )
            .build()
    }
    ...
    internal class Intersection private constructor(
        internal val mySide: Side,
        internal val myPosition: Position,
        internal val myOffset: Double,
        internal val myDirection: OffsetDirection?
    ) {
    ...
    internal class IntersectionBuilder(private val myTarget: DoubleRectangle) {
        ...
        private fun getIntersectionRectangle(
        ...
        private fun getIntersectionPointWithOffset(intersection1: Intersection): DoubleVector {
            ...
            val relativePoint =
                if (intersection1.myDirection == OffsetDirection.FROM_START) segment.start else segment.end
        ...
        fun segmentBySide(side: Side): DoubleSegment {
            return when (side) {
                ...
                Side.LEFT -> MathUtil.leftEdgeOf(myTarget)

                Side.RIGHT -> MathUtil.rightEdgeOf(myTarget)

                Side.TOP -> MathUtil.topEdgeOf(myTarget)

                Side.BOTTOM -> MathUtil.bottomEdgeOf(myTarget)
            }
        }
