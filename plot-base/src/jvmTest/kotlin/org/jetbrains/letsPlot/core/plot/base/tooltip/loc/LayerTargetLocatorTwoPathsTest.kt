...
class LayerTargetLocatorTwoPathsTest {
    ...
    fun nearestX() {
        ...
        val locator = TestUtil.createLocator(
            ...
            TestUtil.horizontalPathTarget(FIRST_PATH_KEY, 100.0, xList),
            TestUtil.horizontalPathTarget(SECOND_PATH_KEY, 200.0, xList)
        )

        val pointInXRange = TestUtil.point(102.0, 110.0)
        ...
        val pointOutOfXRange = TestUtil.point(90.0, 150.0)
        TestUtil.assertEncodedObjects(
    ...
    fun nearestXClosePoints() {
        ...
        val pointInXRange = TestUtil.point(101.0, 110.0)
        TestUtil.assertEncodedObjects(
            locator, pointInXRange,
            FIRST_PATH_KEY,
            SECOND_PATH_KEY
    ...
    fun hoverXY() {
        val locator = TestUtil.createLocator(
            ...
            TestUtil.pathTarget(FIRST_PATH_KEY, listOf(DoubleVector(100.0, 100.0), DoubleVector(110.0, 110.0), DoubleVector(120.0, 120.0))),
        )
