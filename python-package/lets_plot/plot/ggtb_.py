...
def ggtb(zoom_basis=None, zoom_limit=None) -> FeatureSpec:
    """
    ...
    """
    return FeatureSpec(kind='ggtoolbar', name=None, zoom_basis=zoom_basis, zoom_limit=zoom_limit)
