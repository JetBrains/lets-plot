...
def scale_fill_viridis(alpha=None, begin=None, end=None, direction=None, option=None,
    ...
    begin : float, default=0.0
        Corresponds to a color hue to start at. Understands numbers between 0 and 1. Should be less than `end`.
    end : float, default=1.0
        Corresponds to a color hue to end with. Understands numbers between 0 and 1. Should be greater than `begin`.
    direction : {1, -1}, default=1
