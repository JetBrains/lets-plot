...
def maptiles_zxy(url: str, attribution: str = None, min_zoom: int = None, max_zoom: int = None, subdomains: str = None,
    ...
    min_zoom : int
        Minimal zoom limit. Understands integers from 1 to 15. Should be less than or equal to `max_zoom`.
    max_zoom : int
        Maximal zoom limit. Understands integers from 1 to 15. Should be greater than or equal to `min_zoom`.
    subdomains : str
