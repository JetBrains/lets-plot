...
import org.jetbrains.letsPlot.nat.encoding.png.chunks.PngChunkPLTE
import org.jetbrains.letsPlot.nat.encoding.png.chunks.PngChunkTRNS
...
internal object ImageLineHelper {
    ...
    fun convert2rgba(line: IImageLineArray, pal: PngChunkPLTE, trns: PngChunkTRNS?, buf: IntArray?): IntArray {
        ...
        org.jetbrains.letsPlot.nat.encoding.png.fill(buf, maxval)
        if (imi.indexed) {
