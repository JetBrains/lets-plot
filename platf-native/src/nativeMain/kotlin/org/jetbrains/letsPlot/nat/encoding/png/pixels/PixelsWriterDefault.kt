...
import org.jetbrains.letsPlot.nat.encoding.png.FilterType
...
internal class PixelsWriterDefault(imgInfo: ImageInfo) : PixelsWriter(imgInfo) {
    ...
    override fun initParams() {
        ...
        if (rowbprev == null || rowbprev!!.size < buflen) rowbprev = ByteArray(buflen) else org.jetbrains.letsPlot.nat.encoding.png.fill(
            rowbprev!!,
            0.toByte()
        )
