...
class HorizontalTooltipExpanderTest {
    @Test
    fun noOverlapping() {
        val expander = HorizontalTooltipExpander(MathUtil.DoubleRange.withStartAndEnd(0.0, 561.0))
    ...
    private fun newTooltip(text: String, size: DoubleVector, position: DoubleVector, pointer: DoubleVector): PositionedTooltip {
        val spec = TooltipSpec(TipLayoutHint.cursorTooltip(DoubleVector(0.0, 0.0), Color.BLACK), listOf(text), Color.BLACK)
