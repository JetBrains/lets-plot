...
internal class RandomStratifiedSampling(
        ...
        private val myMinSubsampleSize: Int?) : SamplingBase(sampleSize), GroupAwareSampling {
    ...
    override fun apply(population: DataFrame, groupMapper: (Int) -> Int): DataFrame {
        ...
        for (group in indicesByGroup.keys) {
            ...
            if (stratumSampleSize >= stratumSize) {
                ...
                val sampleGroupIndices = SamplingUtil.sampleWithoutReplacement(stratumSize, stratumSampleSize, rand,
                        { indexSet ->
