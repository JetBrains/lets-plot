...
import jetbrains.datalore.visualization.plot.gog.plot.event3.tooltip.layout.LayoutManager.Companion.MARGIN_BETWEEN_TOOLTIPS
import jetbrains.datalore.visualization.plot.gog.plot.event3.tooltip.layout.LayoutManager.Companion.moveIntoLimit
...
internal class HorizontalTooltipExpander(private val mySpace: MathUtil.DoubleRange) {
    ...
    private fun yCoordComparator(t1: PositionedTooltip, t2: PositionedTooltip): Int {
        ...
        val stemCompare = java.lang.Double.compare(t1.stemCoord.y, t2.stemCoord.y)
        return if (stemCompare != 0) {
            stemCompare
        } else java.lang.Double.compare(t1.tooltipCoord.y, t2.tooltipCoord.y)
