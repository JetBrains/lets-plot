...
import jetbrains.datalore.visualization.plot.gog.plot.assemble.PlotGuidesAssemblerUtil.checkFitsColorBar
import jetbrains.datalore.visualization.plot.gog.plot.assemble.PlotGuidesAssemblerUtil.createColorBarAssembler
import jetbrains.datalore.visualization.plot.gog.plot.assemble.PlotGuidesAssemblerUtil.fitsColorBar
import jetbrains.datalore.visualization.plot.gog.plot.assemble.PlotGuidesAssemblerUtil.guideDataRangeByAes
import jetbrains.datalore.visualization.plot.gog.plot.assemble.PlotGuidesAssemblerUtil.mappedRenderedAesToCreateGuides
...
internal object PlotAssemblerUtil {
    ...
    fun createLegends(layersByPanel: List<List<GeomLayer>>,
        ...
        return createLegends(stitchedLayersList, dataRangeByAes, guideOptionsMap, theme)
    }
    ...
    fun rangeByNumericAes(layersByTile: List<List<GeomLayer>>): Map<Aes<*>, ClosedRange<Double>> {
        ...
        for (layers in layersByTile) {
            for (layer in layers) {
                ...
                val xyRanges = PlotUtil.computeLayerDryRunXYRanges(layer, aesthetics)
