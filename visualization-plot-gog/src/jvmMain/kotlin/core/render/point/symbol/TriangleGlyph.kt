...
internal class TriangleGlyph @JvmOverloads constructor(location: DoubleVector, size: Double, pointingUp: Boolean, inscribedInSquare: Boolean = false) : SingletonGlyph(createTriangleShape(location, size, pointingUp, inscribedInSquare)) {
    ...
    companion object {
        ...
        private val SIDE_TO_HEIGHT_RATIO = sin(Math.PI / 3)
