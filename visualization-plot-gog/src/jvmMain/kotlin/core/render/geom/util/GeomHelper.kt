...
import jetbrains.datalore.visualization.plot.gog.core.render.svg.StrokeDashArraySupport
...
open class GeomHelper(private val myPos: PositionAdjustment, coord: CoordinateSystem, protected val ctx: GeomContext) {
    ...
    companion object {
        ...
        fun <T> textLabelAnchor(o: Any, conversionMap: Map<*, T>, def: T): T {
            return (conversionMap as java.util.Map<*, T>).getOrDefault(o, def)
        }
