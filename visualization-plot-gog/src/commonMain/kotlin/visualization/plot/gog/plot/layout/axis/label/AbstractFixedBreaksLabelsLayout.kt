...
internal abstract class AbstractFixedBreaksLabelsLayout(orientation: Orientation,
    ...
    fun noLabelsLayoutInfo(axisLength: Double, orientation: Orientation): AxisLabelsLayoutInfo {
