...
import jetbrains.datalore.visualization.plot.gog.plot.layout.XYPlotLayoutUtil.maxTickLabelsBounds
...
internal class XYPlotTileLayout(private val myXAxisLayout: AxisLayout, private val myYAxisLayout: AxisLayout) : TileLayoutBase() {
    ...
    override fun doLayout(preferredSize: DoubleVector): TileLayoutInfo {
        ...
        var geomBounds = geomBounds(xAxisThickness, yAxisThickness, preferredSize)
        ...
        while (doX) {
            ...
            run {
                ...
                val maxTickLabelsBounds = maxTickLabelsBounds(Orientation.BOTTOM, stretch, geomBounds, preferredSize)
                ...
                if (axisThicknessNew > xAxisThickness) {
                    ...
                    geomBounds = geomBounds(axisThicknessNew, yAxisThickness, preferredSize)
                }
            ...
            if (doY || yAxisInfo == null) {
                ...
                if (axisThicknessNew > yAxisThickness) {
                    ...
                    geomBounds = geomBounds(xAxisThickness, axisThicknessNew, preferredSize)
                }
        ...
        run {
            val maxTickLabelsBounds = maxTickLabelsBounds(Orientation.BOTTOM, 0.0, geomBounds, preferredSize)
        ...
        geomBounds = geomBounds.union(DoubleRectangle(geomBounds.origin, TileLayoutBase.GEOM_MIN_SIZE))

        // Combine geom area and x/y axis
        val geomWithAxisBounds = tileBounds(xAxisInfo!!.axisBounds(), yAxisInfo!!.axisBounds(), geomBounds)
    ...
    companion object {
        ...
        private fun tileBounds(xAxisBounds: DoubleRectangle, yAxisBounds: DoubleRectangle, geomBounds: DoubleRectangle): DoubleRectangle {
            ...
            val leftTop = DoubleVector(
                    ...
                    geomBounds.top - TileLayoutBase.GEOM_MARGIN)
            val rightBottom = DoubleVector(
                    geomBounds.right + TileLayoutBase.GEOM_MARGIN,
