...
import jetbrains.datalore.visualization.plot.gog.core.render.geom.util.GeomUtil.ordered_X
...
internal class SmoothGeom : GeomBase() {
    ...
    private fun buildHints(dataPoints: Iterable<DataPointAesthetics>, pos: PositionAdjustment, coord: CoordinateSystem, ctx: GeomContext) {
        ...
        for (p in dataPoints) {
            ...
            val hint = HintConfigFactory()
                    ...
                    .defaultColor(p.fill()!!, PROPORTION(p.alpha()))
