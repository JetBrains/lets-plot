...
import jetbrains.datalore.livemap.jvmPackage.MonolithicBatikLM
...
object LiveMapPlotConfigDemoUtil {
    fun show(
        ...
        create(title, plotSpecList, factory, plotSize, ::rawSpecPlotBuilder, MonolithicBatikLM::mapsToCanvas)
    }
